...
ros2 topic pub -t 10 --max-wait-time 30 /test_topic std_msgs/String "data: Hello" & ros2 topic echo --timeout 40 --once /test_topic std_msgs/String > /results/$(hostname)
